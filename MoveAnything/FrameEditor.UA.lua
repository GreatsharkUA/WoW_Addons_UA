...
function MovAny:CreateFrameEditor(id, name)
	...
	displayNameLabel:SetText("Фрейм:")
	...
	_G[enabledCheck:GetName().."Text"]:SetText("Увімкнено")
	...
	_G[hideCheck:GetName().."Text"]:SetText("Прихований")
	...
	_G[clampToScreenCheck:GetName().."Text"]:SetText("Притиснути до екрану")
	...
	positionHeading:SetText("Пизиція")
	...
	hideLayersHeading:SetText("Приховати шар")
	...
	_G[unregisterAllEventsCheck:GetName().."Text"]:SetText("Скасувати реєстрацію всіх подій")
	...
	_G[forcedLockPointCheck:GetName().."Text"]:SetText("Примусове блокування позиції")
	...
	revertButton:SetText("Скасувати")
	revertButton.tooltipText = "Повернутися до модифікацій цього елемента, коли було відкрито цей редактор"
	...
	resetButton.tooltipText = "Скинути елемент"
	...
	syncButton:SetText("Синх.")
	syncButton:Disable()
	syncButton.tooltipText = "Синхронізувати всі модифікації"
	...
	moverButton.tooltipText = "Вмикає/вимикає рух для Фрейму"
	...
	showButton.tooltipText = "Перемикає видимість фрейму, будь-які зміни не є постійними. Для постійного приховування використовуйте прапорець \"Приховано\"."
	...
	actualsHeading:SetText("Абсолютні значення")
	...
	infoTextWidthLabel:SetText("Ширина:")
	...
	infoTextAlphaLabel:SetText("Альфа:")
	...
	infoTextHeightLabel:SetText("Висота:")
	...
	infoTextScaleLabel:SetText("Масштаб:")
	...
	fe.UpdateButtons = function()
		...
		if fe.editFrame then
			local mover = MovAny:GetMoverByFrame(fe.editFrame)
			moverButton:Enable()
			moverButton:SetText(mover and "Від'єднати" or "Прикріпити")
			if mover then
				syncButton:Disable()
			else
				syncButton:Enable()
		...
		if fe.editFrame then
			showButton:Enable()
			showButton:SetText(fe.editFrame:IsShown() and "Сховати" or "Показати")
		else
			showButton:Disable()
		end
	end
