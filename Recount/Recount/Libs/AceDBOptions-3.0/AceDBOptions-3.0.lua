...
-- Ukrainian localization 2024-02-16 01:00:00
...
elseif LOCALE == "ruRU" then
	L["default"] = "Стандартний"
	L["intro"] = "Ви можете змінити активний профіль, щоб мати різні параметри для кожного персонажа."
	L["reset_desc"] = "Скиньте поточний профіль до значень за замовчуванням, якщо ваша конфігурація зламана або ви просто хочете почати все спочатку."
	L["reset"] = "Скинути профіль"
	L["reset_sub"] = "Скинути поточний профіль до стандартного"
	L["choose_desc"] = "Ви можете або створити новий профіль, ввівши ім’я у полі редагування, або вибрати один із уже існуючих профілів."
	L["new"] = "Новий"
	L["new_sub"] = "Створити новий чистий профіль"
	L["choose"] = "Існуючі профіля"
	L["choose_sub"] = "Виберіть один із наявних на даний момент профілів."
	L["copy_desc"] = "Скопіюйте налаштування з одного існуючого профілю в поточний активний профіль."
	L["copy"] = "Скопіювати з"
	L["delete_desc"] = "Видаліть наявні та невикористані профілі з бази даних, щоб заощадити місце, і очистіть файл SavedVariables."
	L["delete"] = "Видалити профіль"
	L["delete_sub"] = "Видалення профіля з БД"
	L["delete_confirm"] = "Ви впевнені, що бажаете видалити вибранний профіль?"
	L["profiles"] = "Профілі"
	L["profiles_sub"] = "Керування профілями"
	--L["current"] = "Current Profile:"
end
